...
public class SecurityServiceClientTest {
    ...
    public void testClient() throws DeploymentException {
        ...
        List<CertDataEntry> list = service.get(TestUtils.APP_NAME, TestUtils.SECURITY_ID);
        Hashtable<String, CertDataEntry> temp = new Hashtable<String, CertDataEntry>();
        for (CertDataEntry c : list) {
    ...
    public void assertEntry(Hashtable<String, CertDataEntry> temp, String key, int expected) {
