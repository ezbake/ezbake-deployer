...
public class EzFrackPublisher implements EzPublisher {
    ...
    private byte[] appendKeys(DeploymentArtifact artifact,
        ...
        List<CertDataEntry> entries = getEntriesToAppend(broadcastData, listeningData);
    ...
    private List<CertDataEntry> getEntriesToAppend(Map<String, String> broadcastData, Map<String, String> listeningData) {
        List<CertDataEntry> entriesToAppend = new ArrayList<>(broadcastData.size() + listeningData.size() + 2);
    ...
    private void appendKeys(String parentDirPath, String suffix,  Map<String, String> dataMap,
                            List<CertDataEntry> result) {
        for (String topic : dataMap.keySet()) {
            result.add(new CertDataEntry(new TarArchiveEntry(parentDirPath + topic + suffix),
