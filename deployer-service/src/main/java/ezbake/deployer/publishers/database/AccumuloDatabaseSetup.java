...
public class AccumuloDatabaseSetup implements DatabaseSetup {
    ...
    @Override
    public List<CertDataEntry> setupDatabase(DeploymentArtifact artifact, Properties configuration, EzSecurityToken callerToken) throws DeploymentException{
		...
		try {
            ...
            List<CertDataEntry> entries = Lists.newArrayList();
