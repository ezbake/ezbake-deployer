...
public class AddSShKeys {
    ...
    private EzDeployerConfiguration configuration;

    public static void main(String[] args) throws IOException, DeploymentException, EzConfigurationLoaderException {
        EzDeployerConfiguration deployerConfiguration = new EzDeployerConfiguration(new EzConfiguration().getProperties());
    ...
    public AddSShKeys(EzDeployerConfiguration configuration) {
    ...
    private IOpenShiftConnection getOrCreateConnection() throws DeploymentException {
        try {
            String openshiftUsername = configuration.getOpenshiftUsername();
            String openshiftPassword = configuration.getOpenshiftPassword();
            String openshiftHost = configuration.getOpenshiftHost();
