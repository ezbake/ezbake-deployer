...
public class Rhc {
    ...
    public Rhc() {
        ...
        rootGitDir = EzDeployerConfiguration.getGitTempBaseDir();
        openshiftTimeout = 300000;
        failureRetries = 2;
    }

    public Rhc(EzDeployerConfiguration configuration) {
        openshiftUsername = configuration.getOpenshiftUsername();
        openshiftPassword = configuration.getOpenshiftPassword();
        openshiftHost = configuration.getOpenshiftHost();
        openshiftKeyPassphrase = configuration.getOpenshiftSshPassphrase();
        gitCredentialsProvider = generateGitCredentials();
        rootGitDir = configuration.getOpenshiftGitCheckoutBaseDir();
        openshiftTimeout  = configuration.getOpenshiftTimeout();
        failureRetries = Integer.parseInt(configuration.getEzConfiguration().getProperty("ezdeploy.failed.retries", "2"));
    }
    ...
    public RhcApplication getOrCreateApplication(String applicationId, String domainName,
        ...
        File appDir = Files.resolve(rootGitDir, applicationId);
